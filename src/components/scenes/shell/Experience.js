...
import shellVertexShader from "./shaders/vertex.js";
import shellFragmentShader from "./shaders/fragment.js";
...
function Shell() {
  ...
  return (
    <mesh rotation={[0, 0, 0]} ref={ref}>
      <cylinderGeometry
        ref={geomertyRef}
        args={[0.1, 1.1, 2.0, 512, 512, true]}
      />
      {/* <planeGeometry ref={geomertyRef} args={[1, 1, 2.0, 512, 512]} /> */}
      <shellMaterial side={THREE.DoubleSide} ref={shaderRef} />
    </mesh>
  );
}
