...
import { RightArrowIcon } from "@/theme/icons";
import Container from "@/theme/components/Container";
import ZhavoronskayaPlaneWithLogo from "../../components/scenes/ZhavoronskayaPlaneWithLogo";
...
export default async function HomePage() {
  ...
  return (
    <>
      <ZhavoronskayaPlaneWithLogo />

      <Container maxWidth="792px">
        <div className="mt-xl mb-xxl">
          ...
          <p className="fz-lgr">
            ...
            exploring shaders and 3d on the web. Feel free to reach me out if
            you some porject in mind or just to chat
          </p>
        </div>
        ...
        <div className="mt-xl mb-xl">
          ...
          <p className="fz-lgr">
            Since 2017 I've been lucky enough to produce a couple of releases
            with the help of many beatiful people I've met along the way. Here
            are some of my featured music <Link href="/albums">albums</Link>.
          </p>
        </div>
          ...
          {albums.map((album) => {
            return (
              ...
              >
                ...
                <RightArrowIcon size="30px" color={"var(--clr-link)"} />
              </Link>
            );
          })}
        </div>
        ...
        <div className="mt-xl mb-xl">
          ...
          <p className="fz-lgr">
            Using technologies like WebGL, GLSL, and Three.js I can finally
            create <Link href="/shots">scenes</Link> from my fantasy.
          </p>
        </div>
