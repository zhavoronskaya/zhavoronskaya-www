...
const ExperimentalEighteenMaterial = shaderMaterial(
  {
    uTime: 0,
    uIterration: 4,
  },
...
extend({ ExperimentalEighteenMaterial });
...
function Object() {
  ...
  const { nodes } = useGLTF("../../model//coral.glb");
  ...
  React.useEffect(() => {
    ...
    material.onBeforeCompile = (shader) => {
      ...
      shader.vertexShader = shader.vertexShader.replace(
        ...
        float vDisplacement =100.0*turbulenceFBM(objectNormal, 8, 0.5,2.0);
        vDisplacement = remap(vDisplacement, -10.0, 10.0, 0.0, 1.0);
  ...
  return (
    <group>
      <mesh>
        <sphereGeometry args={[0.06, 512, 512]} />
        <MeshTransmissionMaterial
          ref={transmissionRef}
          distortion={1.0}
          distortionScale={0.1}
      ...
      <mesh geometry={nodes.coral.geometry} ref={ref}>
      ...
      /> */}
        ...
        <experimentalEighteenMaterial ref={shaderRef} wireframe={false} />
      </mesh>
    </group>
  );
}
...
export default function Experience() {
  return (
    <>
      ...
      <color args={["#11011c"]} attach="background" />
      <ambientLight intensity={10.0} color={"#ebc3e6"} />
