...
const ExperimentalTwentythreeMaterial = shaderMaterial(
  {
    uTime: 0,
    uIterration: 4,
...
extend({ ExperimentalTwentythreeMaterial });
...
function Shell() {
  ...
  useEffect(() => {
    ...
    material.onBeforeCompile = (shader) => {
      ...
      shader.vertexShader = shader.vertexShader.replace(
        ...
        vDisplacement = remap(vDisplacement, -10.0, 10.0, 0.0, 0.1);
  ...
  return (
    <group rotation={[-Math.PI / 2, 0, 0]}>
      ...
      <mesh geometry={nodes.shell.geometry} ref={ref}>
        <experimentalTwentythreeMaterial
          ref={shaderRef}
          wireframe={false}
          transparent={true}
        />
...
export default function Experience() {
  return (
    <>
      ...
      {/* <ambientLight intensity={8.0} color={"#d0edf2"} /> */}
      {/* <color args={["#371f40"]} attach="background" /> */}
      <color args={["#061c24"]} attach="background" />
