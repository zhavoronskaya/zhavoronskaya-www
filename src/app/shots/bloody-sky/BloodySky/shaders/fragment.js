...
float strengthTwo = snoise(vec3(pixelCoords, uTime))*15.5;
    ...
    // // Clamp the value
    // strengthTwo = clamp(strengthTwo, 0.0, 1.0);


    //Final Color
    vec3 color = mix(vec3(0.45,0.118,0.88),vec3(0.5), strength * 0.8);
    vec3 finalColor =  mix(vec3(0.421,0.1,0.223),color, strengthTwo*0.9);
