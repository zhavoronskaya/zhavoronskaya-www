...
const FBOParticles = () => {
  const heart = useGLTF("../../model/heart1.glb");
  const text = useGLTF("../../model/text1.glb");
  ...
  const simUniforms = React.useRef({
    positions: { value: makeTexture(heart.scene.children[0].geometry) },
    positionsA: { value: makeTexture(text.scene.children[0].geometry) },
  ...
  return (
    <>
      {/* <mesh position={[0, 0, 0]} geometry={heart.scene.children[0].geometry}>
        <MeshTransmissionMaterial
          distortion={0.0}
          distortionScale={0.0}
          thickness={1.0}
    ...
    <>
      ...
      {/* <EffectComposer multisampling={2}>
        <DepthOfField
          ...
          height={480}
        />
        <Bloom luminanceThreshold={1.0} luminanceSmoothing={0.9} height={500} />
      ...
      {/* <color args={["#080324"]} attach="background" /> */}
      {/* 
      <color args={["#605263"]} attach="background" /> */}
      {/* <GradientTexture
        stops={[0, 1.0]} // As many stops as you want
        colors={["#492d5e", "#07051f"]} // Colors need to match the number of stops
        size={1024} // Size is optional, default = 1024
        attach="background"
      /> */}

      <color args={["#130224"]} attach="background" />
      {/* <GradientTexture
        stops={[0, 1.0]} // As many stops as you want
        colors={["#8013f0", "#130224"]} // Colors need to match the number of stops
        size={1024} // Size is optional, default = 1024
        attach="background"
      /> */}
