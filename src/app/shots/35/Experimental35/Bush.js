...
import simulationFragmentShader from "./shaders/simulationFragmentBush.js";
...
const FBOParticlesBush = () => {
  const points = useRef();
  const simulationMaterialRef = useRef();

  const cotton = useGLTF("../../model/bonsai.glb");
  console.log(cotton);
  ...
  const simUniforms = React.useRef({
    positions: { value: makeTexture(cotton.scene.children[1].geometry) },
...
export default FBOParticlesBush;
