...
void main() {	
  ...
  float t = ridgedFBM(localSpacePosition*1.0, 4, 0.5,2.0)+ sin(localSpacePosition.x*localSpacePosition.z*4.0 +uTime*2.0)-cos(localSpacePosition.y*2.0 +uTime*2.0);
  t = remap(t, -1.0, 1.0, 0.0, 0.9);
  float noiseOne = turbulenceFBM(localSpacePosition*1.0, 8, 0.5,2.0)+ cnoise(vec4(localSpacePosition, uTime))*0.5;
