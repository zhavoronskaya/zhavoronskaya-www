...
void main() {
    ...
    t = remap(t, -1.0, 1.0, 0.3, 0.7);
     ...
     float shellDir =clamp((abs(vUv.y)*3.0), 0.0,1.0) ;
  ...
  // spitalPos = rotateY(angle*PI)*normal;
// spitalPos *=t;
    ...
    newPosition *=rotateY(uTime*PI/4.0);
    vDisplacement =cnoise(vec4(newPosition,uTime))*3.40;
