...
const FBOParticles = () => {
  const dolphin = useGLTF("../../model/dolphinCompr.glb");
  ...
  const simUniforms = React.useRef({
    positions: { value: makeTexture(dolphin.scene.children[0].geometry) },
    positionsA: { value: positionTex },
    positionsB: { value: makeTexture(heart.scene.children[0].geometry) },
