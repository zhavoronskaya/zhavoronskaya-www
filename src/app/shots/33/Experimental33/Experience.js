...
const FBOParticles = () => {
  ...
  const simUniforms = React.useRef({
    positions: { value: makeTexture(flower.scene.children[0].geometry) },
  ...
  return (
    <>
      <mesh position={[0, 0, 0]} geometry={flower.scene.children[1].geometry}>
        <MeshTransmissionMaterial
          distortion={0.5}
          distortionScale={0.9}
          thickness={1.0}
  ...
  return (
    <>
      ...
      <GradientTexture
        ...
        colors={["pink", "#d694c3"]} // Colors need to match the number of stops
