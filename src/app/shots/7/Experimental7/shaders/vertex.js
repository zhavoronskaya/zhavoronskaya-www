...
void main() {	
  ...
  float t = sin(localSpacePosition.x*10.0 +uTime*1.2)*10.0+cos(localSpacePosition.y*localSpacePosition.z*3.0 +uTime*2.0);
  t = remap(t, -1.0, 1.0, 0.2, 0.9);
  float noiseOne = ridgedFBM(localSpacePosition*1.0, 4, 0.5,2.0)*2.0 + cnoise(vec4(localSpacePosition.yyy, uTime*0.5))*0.1;
...
//   noise =  remap(noise, -1.0, 1.0, 0.0, 1.0);
  ...
  // float cell = cellular(vec3(localSpacePosition*10.0));
